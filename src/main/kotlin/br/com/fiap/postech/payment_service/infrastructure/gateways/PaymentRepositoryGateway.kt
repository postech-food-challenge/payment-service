...
class PaymentRepositoryGateway(
    ...
    override suspend fun updatePaymentStatusByOrderId(orderId: Long, paymentValidated: Boolean): Boolean =
        paymentRepository.updatePaymentStatusByOrderId(orderId, paymentValidated)
}